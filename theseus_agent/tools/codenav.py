...
.
    ...
    def function(self, ctx: ToolContext, text: str) -> str:
        ...
        try:
            ...
            output = code_nav_theseus.text_search(
...
#     result = code_nav_theseus.go_to("/Users/arnav/Desktop/theseus/theseus", temp_file_dir, "/Users/arnav/Desktop/theseus/theseus/theseus_agent/session.py", 34, 6, 22)
#     print(result)
# except Exception as e:
#     print(f"Error: {e}")
# finally:
